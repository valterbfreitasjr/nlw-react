...
const InviteGuestsModal = ({closeGuestsModal, emailsToInvite, removeEmailsFromInvites, addNewEmailToInvite } : InviteGuestsModalProps) => {
    return ( <div className="fixed inset-0 flex items-center justify-center bg-black/60">
